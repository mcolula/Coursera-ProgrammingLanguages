...
;; We will test eval-under-env by calling it directly even thoug
...
(define (eval-under-env e env)
  (cond [(var? e) 
        ...
        [(fun? e) (closure env e)]
        [(mlet? e) (let ([ev (eval-under-env (mlet-e e) env)])
                     (eval-under-env (mlet-body e) (cons (cons (mlet-var e) ev) env)))]
        [(apair? e)
           (apair
